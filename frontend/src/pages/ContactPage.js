...
const ContactPage = () => {
    ...
    // إعداد موقع الشركة على الخريطة
    const position = [33.5138, 36.2763]; // إحداثيات دمشق

    // إعداد أيقونة مخصصة للنقطة على الخريطة
    const icon = L.icon({
        iconUrl: '/marker-icon.png', // تأكد من إضافة أيقونة المؤشر إلى مجلد public
        iconSize: [25, 41],
        iconAnchor: [12, 41],
    });
